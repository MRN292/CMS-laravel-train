                    ...
                    <div class="card">
                        <div class="card-header d-flex p-0">
                            ...
                            <ul class="nav nav-pills ml-auto p-2">
                                <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">تب
                                        1</a></li>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <p>با اضافه کردن کلاس <code>.vertical</code> و <code>.progress-sm</code>,
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <dl>
                                ...
                                <dt>تیتیر</dt>
                                <dd>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک
                                    است.</dd>
                                <dd>لورم ایپسوم متن ساختگی.</dd>
                                <dt>تیتر</dt>
                                <dd>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک
