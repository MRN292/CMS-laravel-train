                            ...
                            <div class="row">
                                <div class="col-6 col-md-3 text-center">
                                    <input type="text" class="knob" value="80" data-skin="tron"
                                        data-thickness="0.2" data-width="90" data-height="90" data-fgColor="#3c8dbc"
                                        data-readonly="true">
                                ...
                                <div class="col-6 col-md-3 text-center">
                                    <input type="text" class="knob" value="60" data-skin="tron"
                                        data-thickness="0.2" data-width="120" data-height="120" data-fgColor="#f56954">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <div class="sparkline" data-type="line" data-spot-Radius="3"
                                ...
                                data-offset="90" data-width="100%" data-height="100px" data-line-Width="2"
                        ...
                        <div id="myBody" class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p>
                                        Box Plot: <span
                                            class="sparkboxplot">4,27,34,52,54,59,61,68,78,82,85,87,91,93,100</span><br>
