                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    <div class="direct-chat-info clearfix">
                                        ...
                                        <span class="direct-chat-timestamp float-right">22 دی ساعت 18</span>
                                    </div>
                                    <!-- /.direct-chat-info -->
                                ...
                                <div class="direct-chat-msg right">
                                    <div class="direct-chat-info clearfix">
                                        ...
                                        <span class="direct-chat-timestamp float-left">23 دی ساعت ۱۲</span>
                                    </div>
                                    <!-- /.direct-chat-info -->
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        پروژه‌ها <span class="float-left badge bg-primary">31</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        وظایف <span class="float-left badge bg-info">5</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        پروژه‌های کامل شده <span class="float-left badge bg-success">12</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        دنبال کنند‌ها <span class="float-left badge bg-danger">842</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-widget widget-user">
                        ...
                        <div class="widget-user-header bg-info-active">
                            <h3 class="widget-user-username">حسام موسوی</h3>
                    ...
                    <div class="card card-widget">
                        <div class="card-header">
                            <div class="user-block">
                                ...
                                <span class="username"><a href="#">حسام موسوی</a></span>
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-default btn-sm"><i class="fa fa-share"></i> اشتراک
                                گذاری</button>
                            <button type="button" class="btn btn-default btn-sm"><i class="fa fa-thumbs-o-up"></i>
                                لایک</button>
                            <span class="float-left text-muted">127 لایک - 3 نظر</span>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer card-comments">
                            <div class="card-comment">
                                ...
                                <div class="comment-text">
                                    <span class="username">
                                        زینب فاطمی
                                        <span class="text-muted float-left">12 ظهر امروز</span>
                                    </span><!-- /.username -->
                            ...
                            <div class="card-comment">
                                ...
                                <div class="comment-text">
                                    <span class="username">
                                        فاطمه
                                        <span class="text-muted float-left">16 عصر امروز</span>
                                    </span><!-- /.username -->
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="img-push">
                                    <input type="text" class="form-control form-control-sm"
                                        placeholder="نظر خود را تایپ و ثبت کنید">
                                </div>
                            </form>
                        </div>
                        <!-- /.card-footer -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-widget">
                        ...
                        <div class="card-body">
                            ...
                            <p>تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو
                            ...
                            <button type="button" class="btn btn-default btn-sm"><i class="fa fa-thumbs-o-up"></i>
                                لایک</button>
                            <span class="float-left text-muted">45 لایک‌ - 2 نظر</span>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer card-comments">
                            <div class="card-comment">
